Shader "Custom/PBRShadowMapShader"
{
    Properties
    {
        ...
        _1st_ShadowMap("1stShadowMap", 2D) = "white"{ }
        _2st_ShadowMap("2stShadowMap", 2D) = "white"{ }
    }
        ...
        SubShader
        {
            ...
            Pass
            {
                ...
                TEXTURE2D(_2st_ShadowMap); SAMPLER(sampler_2st_ShadowMap);
            

                CBUFFER_START(UnityPerMaterial)
                float4 _BaseMap_ST;
                float4 _1st_ShadowMap_ST;
                float4 _2st_ShadowMap_ST;
                half4 _BaseColor;
                ...
                half4 frag(Varyings input) : SV_Target
                {
                    ...
                    half4 shadowcol1 = SAMPLE_TEXTURE2D(_1st_ShadowMap, sampler_1st_ShadowMap, input.uv);
                    half4 shadowcol2 = SAMPLE_TEXTURE2D(_2st_ShadowMap, sampler_2st_ShadowMap, input.uv);
                    inputData.shadowCoord = input.shadowCoord + shadowcol1 + shadowcol2;
                    // PBRのライティング計算

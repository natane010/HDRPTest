Shader "Custom/PBRSkinShader"
{
    Properties
    {
        _BaseMap("BaseMap", 2D) = "white" {}
        _2ndTexture("2ndBaseMap", 2D) = "white" {}
        _2ndFlowValue("_2ndFlowValue", Range(0.0, 1.0)) = 0.0
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            TEXTURE2D(_2ndTexture);  SAMPLER(sampler_2ndTexture);
            ...
            Varyings vert(Attributes input)
            {
                ...
                output.vertexLight = VertexLighting(output.positionWS, output.normalWS * _NormalMap_ST);
            ...
            half4 frag(Varyings input) : SV_Target
            {
                ...
                half4 col2 = SAMPLE_TEXTURE2D(_2ndTexture, sampler_2ndTexture, input.uv);
                ...
                inputData.shadowMask = SAMPLE_SHADOWMASK(input.lightmapUV);
                    ...
                    inputData.shadowCoord = TransformWorldToShadowCoord(input.positionWS + col2 * _2ndFlowValue);
                #else

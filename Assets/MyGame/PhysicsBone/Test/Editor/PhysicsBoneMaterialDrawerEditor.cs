...
{
    [CustomPropertyDrawer(typeof(PhysicsBoneSoftBoneMaterial))]
    public class PhysicsBoneMaterialDrawerEditor : PropertyDrawer
    {
            ...
            else
            {
                ...
                if (serializedObject != null)
                {
                    ...
                    if (property.isExpanded)
                    {
                        ...
                        GUI.enabled = property.objectReferenceValue != PhysicsBoneSoftBoneMaterial.defaultMaterial;

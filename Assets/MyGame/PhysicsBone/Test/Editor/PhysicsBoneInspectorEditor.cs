...
using UnityEngine;
using static TK.PhysicsBone.PhysicsSoftBone;

namespace TK.PhysicsBone
{
    [CustomEditor(typeof(PhysicsSoftBone))]
    public class PhysicsBoneInspectorEditor : Editor
    {
        private PhysicsSoftBone softBone;
        ...
        {
            softBone = target as PhysicsSoftBone;

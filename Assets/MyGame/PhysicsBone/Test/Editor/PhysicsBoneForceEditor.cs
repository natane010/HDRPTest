...
{
    [CustomEditor(typeof(PhysicsBoneForceData))]
    public class PhysicsBoneForceEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (m_TurbulenceMode.intValue == (int)PhysicsBoneForceData.TurbulenceMode.Curve)
            {
            ...
            else if (m_TurbulenceMode.intValue == (int)PhysicsBoneForceData.TurbulenceMode.Perlin)
            {
                EditorGUI.indentLevel++;

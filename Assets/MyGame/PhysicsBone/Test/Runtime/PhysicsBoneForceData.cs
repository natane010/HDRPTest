...
{
    [CreateAssetMenu(fileName = "SBForce", menuName = "PhysicsBone/SBForce")]
    public class PhysicsBoneForceData : ScriptableObject
    {
        [SerializeField]
        ...
        [SerializeField, PhysicsBoneCurveRect(0, -1, 1, 2)]
    ...
    public class PhysicsBoneForceField : MonoBehaviour
    {
        [SerializeField, Range(0, 1)]
        private float m_Conductivity = 0.15f;
        public float conductivity { get { return m_Conductivity; } set { m_Conductivity = value; } }

        [SerializeField, PhysicsBoneEditor]
        private PhysicsBoneForceData m_Force;
        public PhysicsBoneForceData force { get { return m_Force; } set { m_Force = value; } }
        ...
        public void DrawGizmos()
        {
            ...
            if (Application.isPlaying)
            {
                ...
                PhysicsBoneUtility.DrawGizmosArrow(Vector3.zero, forceVector, width, Vector3.up);
                PhysicsBoneUtility.DrawGizmosArrow(Vector3.zero, forceVector, width, Vector3.right);

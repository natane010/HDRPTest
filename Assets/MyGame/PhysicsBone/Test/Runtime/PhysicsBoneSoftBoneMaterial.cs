...
{
    [CreateAssetMenu(fileName = "PBMat", menuName = "PhysicsBone/PBMaterial")]
    public class PhysicsBoneSoftBoneMaterial : ScriptableObject
    {
        [SerializeField, Range(0, 1)]
        private float m_Damping = 0.2f;
        public float damping { get { return m_Damping; } set { m_Damping = Mathf.Clamp01(value); } }
        [SerializeField, PhysicsBoneCurveRect(0, 0, 1, 1)]
        ...
        private static PhysicsBoneSoftBoneMaterial m_DefaultMaterial;
        public static PhysicsBoneSoftBoneMaterial defaultMaterial
        {
            get
            {
                if (m_DefaultMaterial == null)
                    m_DefaultMaterial = CreateInstance<PhysicsBoneSoftBoneMaterial>();
